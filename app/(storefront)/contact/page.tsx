  ...
  return (
    <div className="bg-gradient-to-br from-primary/20 to-black border border-primary/20 rounded-2xl p-8 md:p-12">
      ...
      <p className="text-muted-foreground mb-8">
        Reçois les drops exclusifs et les codes promo avant tout le monde. Pas
        de spam, que du style.
      </p>
...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "Pour le Grand Nord (Garoua, Maroua, Ngaoundéré), comptez 3 à 4 jours ouvrables via nos partenaires logistiques.",
  },
  {
    question: "Puis-je essayer en boutique ?",
    answer:
      "Absolument ! Notre showroom à Yaoundé est ouvert pour les essayages. Contactez-nous sur WhatsApp pour l'adresse exacte.",
  },
  {
    question: "Comment payer ?",
    answer:
      "Paiement à la livraison (Cash/Orange Money/MTN Money) pour Yaoundé. Paiement avant expédition pour les autres villes.",
  },
];
      ...
      <Section className="container px-4 md:px-6 mb-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {CONTACT_METHODS.map((method, index) => (
            ...
            >
              <Card
                className={`bg-black/40 backdrop-blur-md border-white/10 transition-all duration-300 ${method.borderColor} ${method.shadow}`}
              >
                <CardContent className="flex flex-col items-center p-8 text-center">
                  <div
                    className={`p-4 rounded-full bg-white/5 mb-6 ${method.color}`}
                  >
