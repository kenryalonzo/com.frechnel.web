...
const STATIC_FALLBACK_BEST_SELLERS: Product[] = [
  {
    ...
    priceOriginal: 45000,
    isPromo: false,
    category: { id: "cat-tenis", name: "Tenis", slug: "tenis" },
    inStock: true,
  ...
  },
  {
    ...
    pricePromo: 12000,
    isPromo: true,
    category: { id: "cat-maillots", name: "Maillots", slug: "maillots" },
    inStock: true,
    slug: "portugal-jersey-2024",
    isNew: false,
    isBestSeller: true,
    gender: "UNISEX",
    tags: [],
    categoryId: "cat-maillots",
    description: "",
  },
  {
    id: "fs-3",
    ...
    priceOriginal: 25000,
    isPromo: false,
    category: { id: "cat-babouche", name: "Babouche", slug: "babouche" },
    inStock: true,
    slug: "babouche-marron-luxe",
    isNew: false,
    isBestSeller: true,
    gender: "UNISEX",
    tags: [],
    categoryId: "cat-babouche",
    pricePromo: null,
    description: "",
  },
];
